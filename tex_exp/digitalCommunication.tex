...
\usepackage{graphicx}
\usepackage{titlesec}
\usepackage[bottom=2cm,footskip=1cm]{geometry}
...
\begin{thebibliography}{99}  
    \bibitem{ref1}Rappaport T S. Wireless Communications--Principles and Practice, (The Book End)[J]. Microwave Journal, 2002, 45(12): 128-129.
    \bibitem{ref2}Tranter W H, Shanmugan K S, Rappaport T S. 通信系统仿真原理与无线应用[J]. 译. 北京: 机械工业出版社, 2005: 289-416.
    \bibitem{ref3}Stüber G L, Steuber G L. Principles of mobile communication[M]. Boston: Kluwer academic, 2001.
    \bibitem{ref4}Ash R B. Information theory[M]. Courier Corporation, 2012.
    \bibitem{ref5}Simon M K, Alouini M S. Digital communication over fading channels[M]. New York: Wiley, 2001.
\end{thebibliography}
\end{document}